...
| --- | --- | --- |
| `debian-latest` | `ghcr.io/ea31337/ansible-role-wine:1.0.4-debian-latest` | Uses `apt` |
| `ubuntu-jammy` | `ghcr.io/ea31337/ansible-role-wine:1.0.4-ubuntu-jammy` | Uses `apt` |
| `ubuntu-noble` | `ghcr.io/ea31337/ansible-role-wine:1.0.4-ubuntu-noble` | Uses `apt` |
